...
final addServiceHistoryUseCaseProvider = Provider<Future<void> Function(ServiceHistory)>((ref) {
...
final updateServiceHistoryUseCaseProvider = Provider<Future<void> Function(String, ServiceHistory)>((ref) {
  final repo = ref.watch(serviceHistoryRepositoryProvider);
...
final deleteServiceHistoryUseCaseProvider = Provider<Future<void> Function(String)>((ref) {
  final repo = ref.watch(serviceHistoryRepositoryProvider);
  return (id) async {
